describe("Exam Joining - Dragos Ibanescu", () => {
    it("should login, navigate to exams, and join an exam", () => {
      ...
      cy.get('input[name="identifier"]').type('ionut_posmangiu'); // Replace with valid username
      cy.get('input[name="password"]').type('ionut_posmangiu123'); // Replace with valid password
