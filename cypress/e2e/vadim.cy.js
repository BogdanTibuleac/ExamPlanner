describe("Exam Joining - Dragos Ibanescu", () => {
    it("should login, navigate to exams, and join an exam", () => {
      ...
      cy.get('input[name="identifier"]').type('vadimverhovetchii'); // Replace with valid username
      cy.get('input[name="password"]').type('vadimverhovetchii123'); // Replace with valid password
